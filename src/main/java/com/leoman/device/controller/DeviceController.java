package com.leoman.device.controller;
...
import com.leoman.measure.service.IMeasureManager;
...
//	@Autowired
//	private IUserDeviceManager iuserDeviceManager;
	@Autowired
	private IAolUserManager iuserManager;
//	@Autowired
//	private IOrganiseManager iOrganiseManager;
	@Autowired
	private IMeasureManager iMeasureManager;
	@Autowired
//	private IOrganiseDeviceManager iOrganiseDeviceManager;
	...
	private static final String DEVICESLIST = "device/list";
...
//		request.setAttribute("isOk", isOk);
	...
	@ResponseBody
	public Map<String,Object> getDevicesDataList(HttpServletRequest request,Integer draw, Integer start,Integer length,String starttime,
												 String deviceSerial,String organiseName,String usedState,String deviceType){
		//获取登录用户
		Admin loginuser = (Admin) request.getSession().getAttribute(Constant.SESSION_MEMBER_GLOBLE);
		String organiseId = "";
...
//		}
	...
	@ResponseBody
	public void doChangeDev(String devIds, String orgId){
//		boolean isOk = false;
...
//		}
	...
	@ResponseBody
	public void getMeasureDataList(HttpServletRequest request){
//		//获取登录用户
//		LoginUserVO loginuser = (LoginUserVO) request.getSession().getAttribute(SecurityConstants.LOGIN_USER);
