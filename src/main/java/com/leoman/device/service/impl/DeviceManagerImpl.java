package com.leoman.device.service.impl;
...
//		}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public PageVO queryDeviceDataList(Device decivesearchvO, int pagenum, int pagesize){
//		List<Device> decivelist = null;
...
//		return pv;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public PageVO queryDeviceDataList(Device decivesearchvO,String organiseId,int pagenum,int pagesize){
...
//		return pv;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public PageVO queryUserDeviceDataList(Device decivesearchvO,String userId, int pagenum,int pagesize){
//		List<DeciveListVO> decivelist = null;
//		PageVO pv = new PageVO();
//		EntityManager em = entityManagerFactory.createEntityManager();
//
...
//		return pv;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public PageVO queryHjDataList(Device device,int pagenum,int pagesize){
//		List<DeciveListVO> decivelist = null;
//		PageVO pv = new PageVO();
//		EntityManager em = entityManagerFactory.createEntityManager();
//
