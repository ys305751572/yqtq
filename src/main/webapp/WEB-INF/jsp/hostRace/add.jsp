            ...
            <div class="block-area">
                ...
                <div class="row">
                    ...
                    <c:if test="${hostRace.id eq null}">
                        <div class="col-md-6 m-b-15">
                            <label>球场名称：</label><%-- 点击选择球场 --%>
                            <input type="text" id="cityId" name="cityId" value="" class="input-sm form-control validate[required]" placeholder="点击选择球场">
                        </div>
                        <p></p>
                    </c:if>
                    <div class="col-md-6 m-b-15">
                        <label>比赛时间：</label>
                        <input type="text" id="startDate" name="startDate" value="${hostRace.startDate}" class="input-sm form-control validate[required]" placeholder="...">
                    </div>
