...
<section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
        ...
        <form id="formId" name="formName" method="post" action="${contextPath}/admin/question/qc/save" enctype="multipart/form-data" class="box tile animated active form-validation-1">
