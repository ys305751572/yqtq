...
<section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
        ...
        <h1 class="page-title">病理/讲座详情</h1>
            ...
            <div class="block-area">
                ...
                <div class="row">
                    <div class="col-md-6 m-b-15">
                        <label>标题</label>
                        <input type="text" id="title" name="title" value="${pg.title}" class="input-sm form-control validate[required]" placeholder="..." disabled>
                    </div>

                    <div class="col-md-6 m-b-15">
                        <label>链接地址</label>
                        <input type="text" id="url" name="url" value="${pg.url}" class="input-sm form-control" placeholder="..." disabled>
                    </div>
                    <div class="col-md-6 m-b-15">
                        <label>类别</label>
