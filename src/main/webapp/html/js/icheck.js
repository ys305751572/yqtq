!function (e) {
    function t(e, t, s) {
        var n = e[0], r = /er/.test(s) ? v : /bl/.test(s) ? p : f, o = s == g ? {
            checked: n[f],
            disabled: n[p],
            indeterminate: "true" == e.attr(v) || "false" == e.attr(b)
        } : n[r];
        if (/^(ch|di|in)/.test(s) && !o)i(e, r); else if (/^(un|en|de)/.test(s) && o)a(e, r); else if (s == g)for (var r in o)o[r] ? i(e, r, !0) : a(e, r, !0); else t && "toggle" != s || (t || e[x]("ifClicked"), o ? n[y] !== u && a(e, r) : i(e, r))
    }

    function i(t, i, s) {
        var l = t[0], g = t.parent(), k = i == f, m = i == v, x = i == p, A = m ? b : k ? h : "enabled", j = n(t, A + r(l[y])), D = n(t, i + r(l[y]));
        if (l[i] !== !0) {
            if (!s && i == f && l[y] == u && l.name) {
                var P = t.closest("form"), T = 'input[name="' + l.name + '"]';
    ...
    function a(e, t, i) {
        var a = e[0], s = e.parent(), d = t == f, l = t == v, u = t == p, g = l ? b : d ? h : "enabled", k = n(e, g + r(a[y])), m = n(e, t + r(a[y]));
    ...
    var d = "iCheck", c = d + "-helper", l = "checkbox", u = "radio", f = "checked", h = "un" + f, p = "disabled", b = "determinate", v = "in" + b, g = "update", y = "type", k = "click", m = "touchbegin.i touchend.i", C = "addClass", w = "removeClass", x = "trigger", A = "label", H = "cursor", j = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent);
    e.fn[d] = function (n, r) {
        var o = 'input[type="' + l + '"], input[type="' + u + '"]', h = e(), b = function (t) {
            t.each(function () {
                var t = e(this);
        ...
        var H = e.extend({
            ...
            labelHover: !0,
            aria: !1
        }, n), D = H.handle, P = H.hoverClass || "hover", T = H.focusClass || "focus", F = H.activeClass || "active", I = !!H.labelHover, L = H.labelHoverClass || "hover", M = 0 | ("" + H.increaseArea).replace("%", "");
        return (D == l || D == u) && (o = 'input[type="' + D + '"]'), -50 > M && (M = -50), b(this), h.each(function () {
            var n = e(this);
            s(n);
            var r, o = this, h = o.id, b = -M + "%", v = 100 + 2 * M + "%", D = {
                position: "absolute",
                top: b,
                left: b,
                display: "block",
                ...
                border: 0,
                opacity: 0
            }, N = j ? {position: "absolute", visibility: "hidden"} : M ? D : {
                position: "absolute",
                opacity: 0
            }, Q = o[y] == l ? H.checkboxClass || "i" + l : H.radioClass || "i" + u, S = e(A + '[for="' + h + '"]').add(n.closest(A)), U = !!H.aria, Z = d + "-" + Math.random().toString(36).substr(2, 6), $ = '<div class="' + Q + '" ' + (U ? 'role="' + o[y] + '" ' : "");
            U && S.each(function () {
